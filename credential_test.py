...
class TestCredential(unittest.TestCase):
    def setUp(self):
        ...
        self.new_credentials = Credential("Alvin","Ngunjiri","abc234","alvinngunjiri@gmail.com") # create Account object
    ...
    def test_init(self):
        ...
        self.assertEqual(self.new_credentials.credentials_name,"Alvin")
        self.assertEqual(self.new_credentials.usr_name,"Ngunjiri")
        self.assertEqual(self.new_credentials.password,"abc234")
        self.assertEqual(self.new_credentials.email,"alvinngunjiri@gmail.com")
    ...
    def test_delete_credentials(self):
            ...
            '''
            self.new_credentials.save_credentials()
            test_credentials = Credential("Test","user","0700105525","test@user.com") # account
            test_credentials.save_credentials()
    ...
    def test_find_credentials_by_credentials_name(self):
        ...
        self.new_credentials.save_credentials()
        test_credentials = Credential("Test","user","0740879049","test@user.com") # new account
        test_credentials.save_credentials()
